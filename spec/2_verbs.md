...
A debug info verb makes the runtime emit an info diagnostic message.
...
A debug warning verb makes the runtime emit a warning diagnostic message.
...
A debug error verb makes the runtime emit an error diagnostic message.
...
A debug fatal verb makes the runtime emit a fatal diagnostic message and terminates the context.
